window.STM32SDIOComponent = {
	template: `
<toggle configfile="hal" name="stm32_sdio" label="Enable SDIO interface for SD card module"
...
if="app_state.MCU.includes('STM32') && app_state.sd_card_v2" configfile="module">
</toggle>
