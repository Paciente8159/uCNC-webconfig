...
oncallback="()=>{setElements('ENABLE_PARSER_MODULES');}">
</toggle>
...
<range name="G5_MAX_SEGMENT_LENGTH" label="G5 segment maximum length: " units="mm" min="0" max="10" step="0.1" vartype="float" initial="1"></range>
</controlgroup>` 
};
